...
export declare type KeyboardButton = ITextButton | IURLButton | ILocationButton | IVKPayButton | IVKApplicationButton;
...
export interface IKeyboardProxyButton {
    options: (IKeyboardTextButtonOptions | IKeyboardURLButtonOptions | IKeyboardLocationRequestButtonOptions | IKeyboardVKPayButtonOptions | IKeyboardApplicationButtonOptions);
