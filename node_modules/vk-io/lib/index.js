...
class APIRequest {
    ...
    [util.inspect.custom](depth, options) {
        ...
        return `${options.stylize(this.constructor.name, 'special')} ${util.inspect(payload, options)}`;
    }
}
...
class Attachment {
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    [util.inspect.custom](depth, options) {
        const payload = util.inspect(this.toJSON(), {
            ...options,
            compact: false
        });
...
class MessageReply {
    ...
    [util.inspect.custom](depth, options) {
        ...
        return `${options.stylize(this.constructor.name, 'special')} ${util.inspect(payload, { ...options, compact: false })}`;
    }
}
